...
<p class="eda-chart-note">交互：hover 查看 session 数；拖动底部滑块缩放长度桶；右上角可还原或保存图片。静态备份图：<a href="assets/figures/eda_session_length_hist.svg">Session 长度分布 SVG</a>。</p>
...
<p class="eda-chart-note">交互：hover 查看绝对事件量和占比；点击 legend 可开关 clicks/carts/orders。静态备份图：<a href="assets/figures/eda_event_type_mix.svg">行为类型分布 SVG</a>。</p>
...
<p class="eda-chart-note">交互：hover 查看每类 session 信号占比；点击 legend 对比 train/test。静态备份图：<a href="assets/figures/eda_session_signals.svg">Session 级信号 SVG</a>。</p>
...
<p class="eda-chart-note">交互：hover 查看日期、星期、三类行为量和 order ratio；拖动底部滑块查看局部时间段。静态备份图：<a href="assets/figures/eda_daily_event_volume.svg">每日事件量 SVG</a>。</p>
...
<p class="eda-chart-note">交互：柱形表示平均日事件量，折线表示 cart/order ratio，用于区分流量高峰和成交强度。</p>
...
<p class="eda-chart-note">交互：log-log 坐标下 hover 查看 rank 与 event count；支持缩放长尾区间。静态备份图：<a href="assets/figures/eda_item_popularity_loglog.svg">Item popularity 长尾 SVG</a>。</p>
...
<p class="eda-chart-note">交互：hover 查看 from -> to 的转移次数和条件概率。静态备份图：<a href="assets/figures/eda_type_transition_heatmap.svg">行为类型转移 SVG</a>。</p>

<div class="eda-chart" data-eda-chart="position"></div>

<p class="eda-chart-note">交互：hover 查看每类行为在 session 相对位置分桶中的占比。静态备份图：<a href="assets/figures/eda_type_position_deciles.svg">行为类型相对位置 SVG</a>。</p>
